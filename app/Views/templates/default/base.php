...
<head>
    ...
    if (!empty($settings->templateInfos->theme_assets['styles'])):
        ...
        <link href="<?php echo base_url('templates/default/assets/vendor/modern-business/styles.css') ?>"
            rel="stylesheet" />
    ...
    <link rel="stylesheet" type="text/css"
        href="/templates/default/assets/vendor/bootstrap-icons/font/bootstrap-icons.min.css">
...
<body class="d-flex flex-column h-100">
                ...
                <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo base_url() ?>">
                    <?php if (empty($settings->logo)) {
                        if (!empty($settings->siteName))
                            ...
                            <div class="bg-success p-2 rounded-3 d-flex align-items-center justify-content-center"
                        ...
                        <img src="<?php echo esc($settings->logo) ?>" alt="<?php echo esc($settings->siteName) ?>"
                            class="img-fluid">
                    <?php } ?>
                </a>
                        ...
                        <li class="nav-item ms-lg-2">
                            <button class="btn btn-primary d-flex align-items-center gap-2" data-bs-toggle="modal"
                                ...
                                <i class="bi bi-search"></i> <span
                                    class="d-none d-xl-inline"><?php echo lang('Frontend.search') ?></span>
                            </button>
                        </li>
                    </ul>
                </div>
    ...
    <?php endif;
    echo script_tag('templates/default/assets/ci4ms.js');
    echo $this->renderSection('javascript');
    if (!empty($settings->templateInfos->customJs)): ?>
        <script type="text/javascript" <?php echo csp_script_nonce(); ?>>
