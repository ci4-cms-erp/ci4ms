                                        ...
                                        <div class="d-flex align-items-end justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="small">
                                                    ...
                                                    <div class="text-muted"><?php echo ($blog->created_at != '0000-00-00 00:00:00') ? $dateI18n::createFromTimestamp(strtotime($blog->created_at), app_timezone(), 'tr_TR')->toLocalizedString('dd MMMM yyyy HH:mm') : '' ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
