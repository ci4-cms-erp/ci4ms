    ...
    public function run()
    {
        ...
        $commonModel->createMany(
            ...
            [
                ...
                ['id' => 11, 'pagename' => 'specialAuthUser', 'description' => 'Kullanıcıya özel yetki verme', 'className' => '-Modules-Backend-Controllers-PermgroupController', 'methodName' => 'user_perms', 'sefLink' => 'user_perms', 'hasChild' => 0, 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => NULL, 'inNavigation' => 0, 'isBackoffice' => 1, 'typeOfPermissions' => '{"create_r": true,"update_r": true}',],
                ...
                ['id' => '69', 'pagename' => 'updateRouteFile', 'description' => 'updateRouteFile', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'updateRouteFile', 'sefLink' => 'updateRouteFile', 'hasChild' => '0', 'pageSort' => '9', 'parent_pk' => NULL, 'symbol' => 'far fa-folder', 'inNavigation' => '1', 'isBackoffice' => '1', 'typeOfPermissions' => '{"create_r": true, "read_r": true, "update_r": true, "delete_r": true}'],
                ['id' => '70', 'pagename' => 'listFiles', 'description' => 'listFiles', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'listFiles', 'sefLink' => 'listFiles', 'hasChild' => '0', 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => '', 'inNavigation' => '0', 'isBackoffice' => '1', 'typeOfPermissions' => '{"read_r": true}'],
                ['id' => '71', 'pagename' => 'readFile', 'description' => 'readFile', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'readFile', 'sefLink' => 'readFile', 'hasChild' => '0', 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => NULL, 'inNavigation' => '0', 'isBackoffice' => '1', 'typeOfPermissions' => '{"read_r": true}'],
                ['id' => '72', 'pagename' => 'saveFile', 'description' => 'saveFile', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'saveFile', 'sefLink' => 'saveFile', 'hasChild' => '0', 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => NULL, 'inNavigation' => '0', 'isBackoffice' => '1', 'typeOfPermissions' => '{"read_r": true, "update_r":true}'],
                ['id' => '73', 'pagename' => 'renameFile', 'description' => 'renameFile', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'renameFile', 'sefLink' => 'renameFile', 'hasChild' => '0', 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => NULL, 'inNavigation' => '0', 'isBackoffice' => '1', 'typeOfPermissions' => '{"update_r": true}'],
                ['id' => '74', 'pagename' => 'createFile', 'description' => 'createFile', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'createFile', 'sefLink' => 'createFile', 'hasChild' => '0', 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => NULL, 'inNavigation' => '0', 'isBackoffice' => '1', 'typeOfPermissions' => '{"create_r": true}'],
                ['id' => '75', 'pagename' => 'createFolder', 'description' => 'createFolder', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'createFolder', 'sefLink' => 'createFolder', 'hasChild' => '0', 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => NULL, 'inNavigation' => '0', 'isBackoffice' => '1', 'typeOfPermissions' => '{"create_r": true}'],
                ['id' => '76', 'pagename' => 'moveFileOrFolder', 'description' => 'moveFileOrFolder', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'moveFileOrFolder', 'sefLink' => 'moveFileOrFolder', 'hasChild' => '0', 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => NULL, 'inNavigation' => '0', 'isBackoffice' => '1', 'typeOfPermissions' => '{"update_r": true}'],
                ['id' => '77', 'pagename' => 'deleteFileOrFolder', 'description' => 'deleteFileOrFolder', 'className' => '-Modules-Backend-Controllers-Methods', 'methodName' => 'deleteFileOrFolder', 'sefLink' => 'deleteFileOrFolder', 'hasChild' => '0', 'pageSort' => NULL, 'parent_pk' => NULL, 'symbol' => NULL, 'inNavigation' => '0', 'isBackoffice' => '1', 'typeOfPermissions' => '{"delete_r": true}']
            ]
        );
