<h4><strong><?= lang('Pages.pages') ?></strong></h4>
<?= empty($pages) ? '<strong>' . lang('Menu.notFindinMenuPages') . '</strong>' : '' ?>
...
<hr>
<h4><strong><?= lang('Blog.blogs') ?></strong></h4>
<?= empty($blogs) ? '<strong>' . lang('Menu.notFindinMenuBlogs') . '</strong>' : '' ?>
