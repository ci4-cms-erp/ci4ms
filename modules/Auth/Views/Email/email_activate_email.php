                    ...
                    <tr>
                        <td style="padding: 40px 30px; text-align: left; color: #333333; line-height: 1.6; font-size: 16px;">
                            ...
                            <p style="font-size: 16px; margin-bottom: 20px;">
                                <?php echo lang('Auth.emailActivateMailBody') ?>
                            </p>

                            <div style="text-align: center; margin: 30px 0;">
                                <div style="display: inline-block; padding: 15px 40px; background-color: #ebf5f3; color: #123a49; border-radius: 8px; font-size: 32px; font-weight: bold; letter-spacing: 5px; border: 2px dashed #8bcbb7;">
                                    <?php echo $code ?>
                                </div>
                            </div>
