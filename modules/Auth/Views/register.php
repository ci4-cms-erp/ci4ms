...
echo lang('Auth.register') . ' | Ci4MS - ' . getenv('app.version');
            ...
            <form action="<?php echo url_to('register') ?>" method="post">
                ...
                <div class="form-floating mb-5">
                    <input type="password" class="form-control" id="floatingPasswordConfirmInput"
                        ...
                        placeholder="<?php echo lang('Auth.passwordConfirm') ?>" required>
                </div>
                ...
                <p class="text-center"><?php echo lang('Auth.haveAccount') ?> <a href="<?php echo url_to('login') ?>"><i
