...
return [
    ...
    'downloadStarter' => 'Download Starter Theme',
    'deleteTheme' => 'Remove Theme',
    'deleteThemeInfo' => 'The following database tables were detected inside this theme folder. Select the ones you want to delete when removing the theme:',
    'deleteFilesAndTables' => 'Delete Theme and Selected Tables',
    'selectAllTables' => 'Select / Deselect All Tables',
    'themeDeletedSuccessfully' => 'Theme removed successfully.',
    'themeActiveCannotDelete' => 'WARNING: This theme is currently active! Please switch to another theme first.',
    'noTablesFound' => 'No migration/database tables were detected for this theme. Only the theme files will be removed.',
    'deleted' => 'Deleted: {0}',
    'tableDeleted' => 'Table deleted: {0}',
];
