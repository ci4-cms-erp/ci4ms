<@php
if (ENVIRONMENT === 'testing') $settings = (object) [];
elseif (!$set = cache('settings')) {
 ...
 */
if (
    !empty($settings->templateInfos->path)
    ...
    if (is_file($routesPath) && realpath($routesPath) === $routesPath) require($routesPath);
}
