                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 150px" class="text-center"><?= lang('Users.authority') ?></th>
                                    ...
                                    <button class="btn btn-outline-dark btn-sm fpwd <?php
                                                                                    if (!empty($userList->reset_expires)) {
                                                                                        ...
                                                                                        if (time() < $time->getTimestamp())
                                                                                            echo 'disabled';
                                                                                    } ?>" data-uid="<?= $userList->id ?>"><?= lang('Users.resetPassword') ?></button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"><?= lang('Users.blackList') ?></h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label for=""><?= lang('Users.whyAddedBlakList') ?></label>
                                                            <div>
                                                                <?= $userList->notes ?>
                                                            </div>
                                                        </div>
                                                ...
                                                <form action="<?= route_to('removeFromBlacklist') ?>" method="post"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-dark"><i
                                                            ...
                                                            <?= lang('Users.removeFromBlackList') ?>
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
