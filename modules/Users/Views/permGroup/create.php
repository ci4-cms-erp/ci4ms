...
<section class="content">
    ...
    <div class="card card-outline card-shl">
        ...
        <div class="card-body">
            <form action="<?php echo route_to('group_create') ?>" method="post" class="form-row">
                <?php echo csrf_field() ?>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="description" cols="30" rows="10" class="form-control" required><?php echo old('description') ?></textarea>
                </div>
                <div class="col-12 row mt-3">
                    <div class="col-12">
                        <h1><?php echo lang('Methods.modules') ?></h1>
                    </div>
