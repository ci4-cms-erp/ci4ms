...
$routes->group('backend/users', ['namespace' => 'Modules\Users\Controllers'], function ($routes) {
    $routes->get('(:num)', 'UserController::users/$1', ['as' => 'users', 'role' => 'create,read,update,delete']);
    ...
    $routes->get('groupList/(:num)', 'PermgroupController::groupList/$1', ['as' => 'groupList', 'role' => 'read,create,update,delete']);
