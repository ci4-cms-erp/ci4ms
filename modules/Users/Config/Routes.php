...
$routes->group('backend/users', ['namespace' => 'Modules\Users\Controllers'], function ($routes) {
    ...
    $routes->match(['GET', 'POST'], 'update_user/(:num)', 'UserController::update_user/$1', ['as' => 'update_user', 'role' => 'update']);
    ...
    $routes->match(['GET', 'POST'], 'user_perms/(:num)', 'PermgroupController::user_perms/$1', ['as' => 'user_perms', 'role' => 'update']);
