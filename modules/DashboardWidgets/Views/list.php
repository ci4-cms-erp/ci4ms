        ...
        <div class="col-md-4">
            <div class="m-stat-card">
                ...
                <div>
                    ...
                    <div class="m-stat-label"><?php echo lang('DashboardWidgets.totalWidgets') ?? 'Total Widgets' ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="m-stat-card">
                ...
                <div>
                    ...
                    <div class="m-stat-label"><?php echo lang('Backend.active') ?? 'Active Widgets' ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="m-stat-card">
                ...
                <div>
                    <div class="m-stat-value"><?php echo $stats['system'] ?></div>
                    <div class="m-stat-label"><?php echo lang('DashboardWidgets.systemWidgets') ?? 'System Widgets' ?></div>
                </div>
            </div>
        </div>
    </div>
